...
from bot.stages.scraping_util import get_promoted_tweet_tweet_link
...
def _scrape(driver: Chrome, bot_username: str):
    ...
    while target > 0:
        ...
        if promoted_in_timeline:
            ...
            ad.seen_on = get_promoted_tweet_official_link(promoted_in_timeline)
            ad.official_ad_link = get_promoted_tweet_tweet_link(promoted_in_timeline, driver)
